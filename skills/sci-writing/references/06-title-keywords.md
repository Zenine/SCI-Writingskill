...
- 标题、关键词、摘要、正文结论使用同一套核心术语(另见 `05-abstract.md`);关键词与标题的分工见关键词规则 2。
...
3. 结果节:优先用动词说出发现的关系或现象(X causes Y / X suppresses Y / X does not affect Y),形式按目标期刊(另见 `03-results.md` 规则 16);期刊只允许短语式小标题时,用含关系的名词短语(Effects of X on Y / Association between X and Y / Suppression of Y by X),两种形式下都不得只给主题名词。
