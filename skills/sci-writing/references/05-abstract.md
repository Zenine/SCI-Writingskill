...
- 用户已有中文摘要,需要转成英文并对齐功能步。
- 审稿或编辑意见指出"摘要只是结果清单""看不出贡献是什么""摘要与正文结论强度不一致"。
- 用户要写 Highlights、Significance Statement 或图形摘要的文字说明。
...
- 写完摘要后回头核对标题与关键词(见 `06-title-keywords.md`),三者要用同一套核心术语。
...
|---|---|---|---|---|---|---|
| 1 | 宏观入口:任何学科读者都能懂的领域场景或重要性 | X is essential for Y / X plays a key role in Y / During X, Y ... | 一般现在时;带时间短语的重要性声明用现在完成时 | 可选,0–1 句;窄读者群期刊可省 | 归入 Background | 必写,1–2 句,不用数字、缩写、单位 |
| 2 | 具体背景:理解本研究必需的概念或既有认识 | More specifically, X ... / X has been widely used to ... | 一般现在时;已确立的进展用现在完成时 | 可选,0–1 句 | 归入 Background | 必写,2–3 句 |
| 3 | 问题 / 空白:已知—但未知的对照 | While X is well documented, it remains unclear whether ... / However, little is known about ... | 现在完成时(否定)或一般现在时 | 必写,1 句 | Background 末句 | 必写,1 句 |
| 4 | 本文做了什么 / 目标:认领贡献 | Here we show that ... / In this study, we ... / This paper presents ... | 一般现在时;已完成的开发可用现在完成时 | 必写,1 句(可与步 8 合并) | Objectives,1 句 | 必写,1 句,常用 Here we show |
...
| 8 | 成就 / 贡献 / 价值:至少一句明确认领 | Our results provide the first evidence that ... / This approach fills a gap in ... | 现在完成时或一般现在时 | 必写,1 句 | Conclusions / Take-aways,2–3 句,须呼应 Background 与 Objectives | 并入步 7 或步 9 |
...
5. 结果句(步 5–6)合计不超过摘要一半;通篇只是结果清单的摘要不合格。
...
15. Highlights 每条一句、独立成意、不复制摘要原句、不超过期刊规定条数;Significance 段面向跨学科读者,讲"为什么重要 + 发现 + 更广影响"。两者是摘要的附件,不能替摘要承担功能。
...
| 错误模式 | 修正原则 |
|---|---|
| 摘要由各节各抄一句拼成,句间无衔接 | 全文定稿后按九步序列重写;检查每两句之间的"缝隙"读者能否跨过 |
| 第一句就是方法细节、样本量或设备名 | 第一句只能是宏观入口 / 问题 / 本文做了什么 |
...
12. we 全篇只指作者。✓/✗
13. this / it / which 所指唯一。✓/✗
14. 同一对象全篇一个名称。✓/✗
15. 平均句长不超过 25 词,单句不超过 40 词。✓/✗
16. 缩写首次给全称;只出现一两次的没有缩写。✓/✗
17. 没有引文,或引文属于直接继承 / 显著改进 / 反驳三种情形。✓/✗
18. 结构化摘要每句都能归入某小标题,各块不留空不重复。✓/✗
19. Highlights / Significance(若有)与摘要不重复,各自独立成意。✓/✗
...
3. 摘要面向谁:书B(第 2、3 章)要求摘要与引言开头让学科外读者读懂,书A 面向同行专家的高密度压缩。裁决:综合性期刊或社会影响导向期刊(Nature / Science 系、Lancet 系)按书B,步 1–2 必写、不用数字缩写;专业细分期刊按书A,步 1–2 可压缩或省略。
