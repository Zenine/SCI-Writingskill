...
10. 本文介绍句中的评价词须能由结果节证据支撑(如 interpretable、diabetes-specific、externally validated 这类可指到具体结果的词),强度不得超过结果所能支撑的程度;novel / robust / first 无据不用,有据可用,口径见 `10-chinese-author-pitfalls.md` W3 与 `09-academic-style.md` 规则 7、9(裁决见 `05-abstract.md` 两书分歧第 6 条)。
...
13. 句长与段长的数字按 `09a-metrics-table.md` 统一口径,本文件不另立数字。
...
16. 没有连续的单句段落;段长按 `09a-metrics-table.md` 口径;从短草稿改写时段落均值不作硬指标,只看 80–230 词区间(见 09 统一口径表)。✓/✗
17. 句长按 `09a-metrics-table.md` 口径,超阈值的句子已拆分或说明理由;从短草稿改写时同第 16 条,段长只看 80–230 区间不看均值(见 09)。✓/✗
