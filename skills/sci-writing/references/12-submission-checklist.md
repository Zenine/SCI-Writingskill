...
8. 每段一个功能,能写出功能句并以表明功能的叙述句开头;与功能无关的句子已删;段长在 `09a-metrics-table.md` 口径内(均值 150–170 词),无整页一段或连续单句段。✓/✗
...
31. 句长按 `09a-metrics-table.md` 口径:平均 20–26 词;> 30 词的句子已检查,> 40 词的已拆或有理由。✓/✗
